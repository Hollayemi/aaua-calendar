...
const CalendarModal = () => {
    ...
    const { notes, location, title, start, end } = formValues;
    ...
    const isFormValid = () => {
        if (title.trim().length === 0) {
            ...
            dispatch(setError("Notes length must be max 500 characters"));
            return false;
        }
    ...
    return (
        ...
        >
            <h1 className="modal__title text-[18px] font-black">
